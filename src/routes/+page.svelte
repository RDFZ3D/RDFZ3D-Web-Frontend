...
>
  <div
    class="card bg-neutral/40 text-neutral-content items-center p-6 shadow-xl backdrop-blur-sm md:p-16"
  >
    ...
    <p class="mb-8 max-w-xl text-lg whitespace-pre-line drop-shadow">
    ...
    <div class="flex w-full justify-center">
      <a href="/user/login" class="link link-hover opacity-70">
        {$LL.user.functions.login.title()}
        / {$LL.user.functions.register.title()}
      </a>
    </div>
  </div>
</div>
